package dev.theparanker.customcurrency.plugin.command;
...
import dev.theparanker.customcurrency.plugin.bootstrap.CustomCurrencyPlugin;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (currency != null) {
            ...
            if (subCommands.containsKey(args[0])) {
                if (sender.hasPermission(subCommands.get(args[0]).permission())) {
